    ...
    play(){
        ...
        if(player.distance < 10350){
            if(keyIsDown(38) && player.index !== null){
                ...
                if(keyIsDown(37)){
                    xVel -= 0.2;
                    console.log("in 2ns left condition");

                }
                if(keyIsDown(39)){
                    xVel += 0.2;
                    console.log("in 2ns right condition");

                }
                console.log("in 2ns ifdddd condition");

            }else if(keyIsDown(38) && yVel > 0 && player.index !== null){
                yVel -= 0.1;
                xVel *= 0.9;
                console.log("in 2ns if condition");
            }else{
                yVel *= 0.985;
                xVel *= 0.985;
                console.log("in 3ns if condition")
